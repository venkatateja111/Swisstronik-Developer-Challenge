...
async function main() {
    ...
    const voterAddress = addr1.address;
    const tx = await sendShieldedTransaction(signer, contractAddress, contract.interface.encodeFunctionData(functionName, [voterAddress]), 0);
    await tx.wait();
